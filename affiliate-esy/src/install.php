...
if ( ! class_exists( 'AFFILIATE_ESY_INSTALL' ) ) {
	...
	final class AFFILIATE_ESY_INSTALL {
		...
		public function text_domain_cb() {
			...
			load_textdomain($this->textDomin, AFFILIATE_ESY_LN . 'affiliate-success-site-' . $locale . '.mo');
			load_plugin_textdomain( $this->textDomin, false, AFFILIATE_ESY_LN );
		}
